...
--
-- Host: 127.0.0.1
-- Creato il: Ott 24, 2017 alle 12:44
...
('BlackPepper@zelig.it', 'Franco', 'Neri', 'soverato89', '8284394850969483'),
...
CREATE TABLE `utente_veicolo` (
  ...
  `Periodo_di_Inizio` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(3, 'carmen.totino@ied.it', 'EF757RE', '2017-10-24 12:32:00');
...
--
ALTER TABLE `utente_veicolo`
  MODIFY `ID_Rent` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
